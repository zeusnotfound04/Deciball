        ...
        >
          <Card className="bg-midnight-surface border border-graphite rounded-cards text-paper-white">
            <CardContent className="p-8 space-y-8">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">2. Description of Service</h2>
                <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">3. User Accounts</h2>
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">3.1 Account Creation</h3>
                    <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">3.2 Account Responsibility</h3>
                    <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">4. Third-Party Services</h2>
                <div className="space-y-4">
                  <div>
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">4.3 Third-Party Liability</h3>
                    <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">5. Acceptable Use Policy</h2>
                <div className="space-y-4">
                  <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">You agree not to:</p>
                  <ul className="font-satoshi text-[17px] text-ghost-gray space-y-2 ml-6 list-disc">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">6. Content and Intellectual Property</h2>
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">6.1 User Content</h3>
                    <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">6.2 Service Content</h3>
                    <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">6.3 Music Content</h3>
                    <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">7. Privacy and Data</h2>
                <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">8. Service Availability</h2>
                <div className="space-y-4">
                  <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">9. Termination</h2>
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">9.1 Termination by You</h3>
                    <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
                      You may terminate your account at any time by discontinuing use of the service and deleting your account.
                    </p>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">9.2 Termination by Us</h3>
                    <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">10. Disclaimers and Limitation of Liability</h2>
                <div className="space-y-4">
                  <div>
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">10.2 Limitation of Liability</h3>
                    <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">11. Changes to Terms</h2>
                <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">12. Governing Law</h2>
                <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">13. Contact Information</h2>
                <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
