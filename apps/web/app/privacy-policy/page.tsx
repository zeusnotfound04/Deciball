  ...
  return (
    <DarkGradientBackground>
      <div className="min-h-screen relative overflow-hidden">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold font-serif italic text-paper-white mb-4">
            Privacy Policy
          </h1>
        ...
        >
          <Card className="bg-midnight-surface border border-graphite rounded-cards text-paper-white">
            <CardContent className="p-8 space-y-8">

              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">1. Introduction</h2>
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">2. Information We Collect</h2>
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">2.1 Account Information</h3>
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">2.2 Usage Data</h3>
                    <ul className="font-satoshi text-[17px] text-ghost-gray space-y-2 ml-6 list-disc">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">2.3 Third-Party Data</h3>
                    <ul className="font-satoshi text-[17px] text-ghost-gray space-y-2 ml-6 list-disc">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">2.4 Technical Data</h3>
                    <ul className="font-satoshi text-[17px] text-ghost-gray space-y-2 ml-6 list-disc">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">3. How We Use Your Information</h2>
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">3.1 Service Provision</h3>
                    <ul className="font-satoshi text-[17px] text-ghost-gray space-y-2 ml-6 list-disc">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">3.2 Personalization and Recommendations</h3>
                    <ul className="font-satoshi text-[17px] text-ghost-gray space-y-2 ml-6 list-disc">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">3.3 Communication and Support</h3>
                    <ul className="font-satoshi text-[17px] text-ghost-gray space-y-2 ml-6 list-disc">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">3.4 Security and Compliance</h3>
                    <ul className="font-satoshi text-[17px] text-ghost-gray space-y-2 ml-6 list-disc">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">4. Data Storage and Security</h2>
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">4.1 Data Storage</h3>
                    <ul className="font-satoshi text-[17px] text-ghost-gray space-y-2 ml-6 list-disc">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">4.2 Security Measures</h3>
                    <ul className="font-satoshi text-[17px] text-ghost-gray space-y-2 ml-6 list-disc">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">4.3 Data Retention</h3>
                    <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">5. Third-Party Services and Data Sharing</h2>
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">5.1 Spotify Integration</h3>
                    <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed mb-2">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">5.2 Google Authentication</h3>
                    <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">5.4 AWS S3</h3>
                    <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">5.5 Data Sharing Policy</h3>
                    <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">6. Your Privacy Rights</h2>
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">6.1 Access and Control</h3>
                    <ul className="font-satoshi text-[17px] text-ghost-gray space-y-2 ml-6 list-disc">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">6.3 Communication Preferences</h3>
                    <ul className="font-satoshi text-[17px] text-ghost-gray space-y-2 ml-6 list-disc">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">7. Cookies and Tracking</h2>
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">7.1 Essential Cookies</h3>
                    <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">7.2 Performance and Analytics</h3>
                    <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-serif italic text-paper-white mb-2">7.3 Local Storage</h3>
                    <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">9. International Data Transfers</h2>
                <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">11. Legal Basis for Processing</h2>
                <div className="space-y-4">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 font-serif italic text-paper-white">12. Contact Us</h2>
                <div className="space-y-4">
                  <p className="font-satoshi text-[17px] text-ghost-gray leading-relaxed">
              ...
              <div className="pt-8 border-t border-graphite">
                <p className="text-center font-mono text-xs text-steel-gray">
