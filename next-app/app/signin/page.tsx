        ...
        <div className="bg-gray-900 bg-opacity-90 backdrop-blur-xl rounded-2xl shadow-2xl p-8 transform hover:scale-105 transition-all duration-500 ease-out border border-gray-800 hover:border-gray-700">
          ...
          <div className="relative z-10">
            ...
            <button
              ...
              className="w-full bg-white hover:bg-gray-50 text-gray-900 font-semibold py-4 px-6 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300 ease-out hover:shadow-2xl active:scale-95 flex items-center justify-center space-x-3 group"
            >
              {/* Google Logo */}
